...
var team2_Score = 0;
var team2_Wickets = 0;
var team1_BallsFaced = 0;
var team2_BallsFaced = 0;
var turn = 1;
...
function gameOver() {
  ...
  function updateScore() {
    ...
    team1Wickets.textContent = team1_Wickets;
    team2Score.textContent = team2_Score;
    team2Wickets.textContent = team2_Wickets;
  }
  ...
  if (turn === 2) {
    ...
    document.querySelector(
      `#team2-superover div:nth-child(${team2_BallsFaced})`
    ...
    if (turn === 1) {
        team1_BallsFaced++;
        document.querySelector(
          `#team1-superover div:nth-child(${team1_BallsFaced})`
        ).textContent = randomElement;
        if (randomElement === "W") {
          team1_Wickets++;
        } else {
        ...
        if (team1_BallsFaced === 6 || team1_Wickets === 2) turn = 2;
      }
      updateScore();
    };